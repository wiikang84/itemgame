...
- **Phase 1 (0~60%)**: 외곽 림 자유 회전 (독립 easeOutCubic)
- **Phase 2 (60~75%)**: 안쪽으로 떨어지며 당첨 포켓에 수렴 (각도 블렌딩 + 바운스)
- **Phase 3 (75~100%)**: 포켓 고정, 휠과 함께 감속 → 순간이동 완전 제거
- **포징 (3초)**: 당첨 슬라이스 하이라이트 + 볼 글로우 펄스 + 줌인 1.15배
